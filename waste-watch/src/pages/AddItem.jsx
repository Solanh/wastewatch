...
function Home() {
    ...
    const saveMenuToBackend = async (id, currentItems, currentName) => {
        ...
        try {
            ...
            const meal_period = currentMenuMeta?.meal_period ?? 1;
                ...
                <div className="container mt-5 pt-5 pb-5">
                    ...
                    <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                        <div>
                            ...
                            <small className="text-muted">
                                Track items, leftovers, and waste for your selected menu.
                            </small>
                        </div>

                        <div className="d-flex flex-column">
                            <label className="form-label mb-1">Select Menu</label>
                            <select
                    ...
                    {!loading && !error && items.length > 0 && (
                        <div className="row g-4">
                            ...
                            <div className="col-12 col-lg-6">
                                <div className="card shadow-sm h-100">
                                    <div className="card-body">
                                        <h5 className="card-title mb-3">Menu Breakdown</h5>
                            ...
                            {/* RIGHT HALF: Summary (and future analytics) */}
